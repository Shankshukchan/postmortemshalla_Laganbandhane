	...
	<>
		...
		<section className="w-full bg-gradient-to-br from-[#FFF8F0] to-[#FDF6EC] py-16 px-4 flex flex-col items-center justify-center relative overflow-hidden">
			...
			<div className="max-w-2xl mx-auto text-center relative z-10">
				...
				<p className="text-lg md:text-xl text-[#6E1E1E] mb-6">We’re here to help you with all your wedding and event needs. Reach out to us for support, questions, or a friendly chat!</p>
		...
		<section className="w-full py-12 px-4 flex flex-col items-center justify-center bg-[#FFF8F0]">
			<div className="max-w-2xl mx-auto text-center">
				...
				<p className="text-lg text-[#6E1E1E] mb-6">Stop by our Mumbai office for a personal consultation or to discuss your event in detail. We’re always happy to meet our clients in person and help make your special day perfect.</p>
