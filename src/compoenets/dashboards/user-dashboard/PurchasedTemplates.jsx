      ...
      {templates.map((tpl) => (
        ...
        >
          ...
          <div className="w-full flex-1 flex flex-col items-center">
            <h4 className="text-lg font-bold text-[#6E1E1E] mb-1 text-center">{tpl.title}</h4>
            <p className="text-sm text-[#6E1E1E] mb-2 text-center">{tpl.description}</p>
            <span className="text-xs text-gray-500 mb-2">Purchased on: {tpl.date}</span>
          </div>
          <div className="flex gap-2 w-full">
            <button className="flex-1 bg-[#D4AF37] text-white px-4 py-2 rounded hover:bg-[#bfa13a] transition">View Layout</button>
            <a
